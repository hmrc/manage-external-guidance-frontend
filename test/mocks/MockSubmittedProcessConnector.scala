...
trait MockSubmittedProcessConnector extends MockFactory {

  val mockConnector: SubmittedProcessConnector = mock[SubmittedProcessConnector]

  object MockSubmittedProcessConnector {
