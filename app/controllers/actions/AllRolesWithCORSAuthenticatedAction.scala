...
trait AllRolesWithCORSAction extends IdentifierAction

class AllRolesWithCORSAuthenticatedAction @Inject() (
...
) extends PrivilegedAction with AllRolesWithCORSAction {

  override val unauthorisedReplyHeaders: Seq[(String, String)] = Seq(
