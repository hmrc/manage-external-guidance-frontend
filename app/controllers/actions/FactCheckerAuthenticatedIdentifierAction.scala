...
) extends AuthenticatedIdentifierBaseAction (authConnector, appConfig, parser, config, env) with FactCheckerIdentifierAction {

  override def accessRestrictions(): Predicate = Enrolment(appConfig.factCheckerRole)
